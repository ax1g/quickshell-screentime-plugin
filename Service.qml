...
Item {
  ...
  // Reacts the moment the lock state flips, instead of waiting on
  // reconcileTimer's 2s poll: closes the bucket the instant the screen
  // locks, and resumes tracking the instant it unlocks.
  Connections {
